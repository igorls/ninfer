 ...
 * every positive T. The current NVFP4 problems register the five non-vocabulary BF16-scale FP8
 * geometries and accept every positive T. Text and MTP packed-weight problems accept every
