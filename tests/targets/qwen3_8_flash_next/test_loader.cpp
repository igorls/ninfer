...
int test_real_artifact_preflight_if_available() {
    ...
    if (report.runtime_plan.total_device_bytes != 335'800'832ULL) {
        std::cerr << "Preflight runtime total_device_bytes mismatch: expected 335800832 got "
    ...
    if (report.runtime_plan.attention_kv_bytes != 100'663'296ULL ||
        ...
        report.runtime_plan.workspace_bytes != 170'496ULL) {
